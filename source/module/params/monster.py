...
'''
monsterParams = {
    "WOLF_LV1":MonsterParam("WOLF", 96, 0, 16, 16, 1, 5, 2, 1, 4, 2, 0, 3, 6, True),
    "BAT_LV1":MonsterParam("BAT", 0, 0, 16, 8, 2, 2, 3, 1, 8, 3, 0, 3, 10, True),
    "BAT_LV2":MonsterParam("BAT", 0, 0, 16, 8, 2, 2, 3, 1, 8, 3, 0, 5, 20, True),
    "KOBOLD_LV1":MonsterParam("KOBOLD", 16, 0, 16, 16, 2, 10, 5, 5, 5, 6, 30, 5, 8, True),
    "KOBOLD_LV2":MonsterParam("KOBOLD", 16, 0, 16, 16, 2, 10, 5, 5, 5, 6, 30, 7, 15, True),
    "ZOMBIE_LV1":MonsterParam("ZOMBIE", 48, 0, 16, 16, 1, 8, 3, 2, 2, 2, 0, 2, 5, False),
    "ZOMBIE_LV2":MonsterParam("ZOMBIE", 48, 0, 16, 16, 1, 8, 3, 2, 2, 2, 0, 4, 12, False),
    "SKELETON_LV1":MonsterParam("SKELETON", 32, 0, 16, 16, 2, 12, 4, 4, 4, 5, 20, 3, 5, False),
    "SKELETON_LV2":MonsterParam("SKELETON", 32, 0, 16, 16, 2, 12, 4, 4, 4, 5, 20, 4, 12, False),
    "GOBLIN_LV1":MonsterParam("GOBLIN", 80, 0, 16, 16, 3, 18, 6, 9, 7, 7, 40, 5, 10, True),
    "GOBLIN_LV2":MonsterParam("GOBLIN", 80, 0, 16, 16, 3, 18, 6, 9, 7, 7, 40, 7, 15, True),
    "AZTEC_LV1":MonsterParam("AZTEC", 64, 0, 16, 16, 3, 20, 7, 8, 8, 8, 60, 2, 5, True),
    "AZTEC_LV2":MonsterParam("AZTEC", 64, 0, 16, 16, 3, 20, 7, 8, 8, 8, 60, 5, 8, True),
    "LION_LV1":MonsterParam("LION", 112, 0, 16, 16, 3, 26, 8, 6, 6, 10, 0, 1, 2, True),
    "LION_LV2":MonsterParam("LION", 112, 0, 16, 16, 3, 26, 8, 6, 6, 10, 0, 2, 5, True),
